...
namespace MineSweeperClassLibrary
{
    public class Board
    {
        ...
        public Board(int size, int difficulty)
        {
            ...
            switch (difficulty)
            {
                case 1: this.Difficulty = 8; break;
                case 2: this.Difficulty = 16; break;
                case 3: this.Difficulty = 24; break;
                case 4: this.Difficulty = 32; break;
                case 5: this.Difficulty = 5; break;
            }
        }
